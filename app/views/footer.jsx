<div id="footer">
  <div class="section">
    <div class="section_content">
      ...
      <div class="one_third">
        <h3 class="footer_title"><span>Latest Tweets</span></h3>

        <ul id="twitter_update_list">
          <li></li>
        </ul>
        <p><a href="http://twitter.com/Blogsessive" class="twitter_link"><strong>Follow me on Twitter</strong></a></p>
        <!-- Edit the above link to make it point to your own Twitter profile -->
      </div>
